...
type BlogServiceClient interface {
	...
	Delete(ctx context.Context, in *Blog, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *blogServiceClient) Delete(ctx context.Context, in *Blog, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type BlogServiceServer interface {
	...
	Delete(context.Context, *Blog) (*emptypb.Empty, error)
...
func (UnimplementedBlogServiceServer) Delete(context.Context, *Blog) (*emptypb.Empty, error) {
...
func _BlogService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlogServiceServer).Delete(ctx, req.(*Blog))
	}
	return interceptor(ctx, in, info, handler)
}
